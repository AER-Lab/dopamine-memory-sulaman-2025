...
<p>
    <img src=2BarGrip_Images/2BarGrip1.jpg height="290"> <img src=2BarGrip_Images/2BarGripSetup2.jpg height="290"> <img src=2BarGrip_Images/HookDimensions.jpg height="290">
   </p>
<p>
    <img src=2BarGrip_Images/Example3.jpg height="290">
   </p>
<!--<p>
    <img src=2BarGrip_Images/Example4.jpg height="290">
   </p>
<p>
    <img src=2BarGrip_Images/Example6.jpg height="290">
   </p>-->

The link to the paper that this tool was commissioned for can be found here -> DOI: [10.1126/sciadv.adw7427](https://doi.org/10.1126/sciadv.adw7427)
...
After printing, remove supports using a small pliers to make sure the hooks will fit smoothly over the edge of the cage.
...
<p>
    <img src=2BarGrip_Images/SlicerOrientation.jpg height="290">
   </p>
